...
async function gradeAssignment(assignmentText, topicName) {

    const prompt = `
      You are a college professor grading an assignment on ${topicName}. Evaluate the student's submission based on the following criteria:
